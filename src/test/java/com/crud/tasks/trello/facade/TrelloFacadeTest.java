...
class TrelloFacadeTest {
    ...
    void shouldCreateCard() {
        // Given
        TrelloCardDto trelloCardDto = new TrelloCardDto("test", "test card", "test", "list1");
        TrelloCard mappedTrelloCard = new TrelloCard("test", "test card", "test", "list1");
        CreatedTrelloCardDto testCreatedTrelloCardDto = new CreatedTrelloCardDto("test", "test", "http");
        ...
        when(trelloService.createTrelloCard(trelloCardDto)).thenReturn(testCreatedTrelloCardDto);
        // When
